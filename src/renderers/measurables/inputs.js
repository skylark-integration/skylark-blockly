define([
  ...
  return {
    ExternalValueInput : Blockly.blockRendering.ExternalValueInput,
    InlineInput : Blockly.blockRendering.InlineInput,
    InputConnection : Blockly.blockRendering.InputConnection,
    StatementInput : Blockly.blockRendering.StatementInput
  };
});
