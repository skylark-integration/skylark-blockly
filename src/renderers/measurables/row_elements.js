define([
  ...
  return {
    Field : Blockly.blockRendering.Field,
    Hat : Blockly.blockRendering.Hat,
    Icon : Blockly.blockRendering.Icon,
    InRowSpacer : Blockly.blockRendering.InRowSpacer,
    JaggedEdge : Blockly.blockRendering.JaggedEdge,
    RoundCorner : Blockly.blockRendering.RoundCorner,
    SquareCorner : Blockly.blockRendering.SquareCorner
